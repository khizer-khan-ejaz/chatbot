        ...
        const generateBotResponse = async (incomingMessageDiv) => {
          ...
          try {
            ...
            if (cachedResponse) {
              ...
              fetch('https://fastapi-vercel-iota.vercel.app/chat', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ message: "Test", browserId: "12345" }),
              }).then(response => response.json())
                .then(data => console.log(`Time: ${performance.now() - startTime}ms`, data));
